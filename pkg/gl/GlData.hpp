...
struct GlData: public NodeData{
	...
	#define woo_gl_GlData__CLASS_BASE_DOC_ATTRS_PY \
		...
		, /* py */ \
		.def_static("_getDataOnNode",&Node::pyGetData<GlData>).staticmethod("_getDataOnNode").def_static("_setDataOnNode",&Node::pySetData<GlData>).staticmethod("_setDataOnNode")

...
struct Tracer: public PeriodicEngine{
	...
	virtual void run() WOO_CXX11_OVERRIDE;
	enum{SCALAR_NONE=0,SCALAR_TIME,SCALAR_TRACETIME,SCALAR_VEL,SCALAR_ANGVEL,SCALAR_SIGNED_ACCEL,SCALAR_RADIUS,SCALAR_SHAPE_COLOR,SCALAR_KINETIC,SCALAR_ORDINAL,SCALAR_MATSTATE};

...
BOOST_PYTHON_MODULE(_utils2){
	...
	_PY_MOD def("pWaveDt",pWaveDt,WOO_PY_ARGS(py::arg("scene")=py::none(),py::arg("noClumps")=false),"Get timestep accoring to the velocity of P-Wave propagation; computed from sphere radii, rigidities and masses.");

...
>{
	...
	#define woo_dem_CGeomFunctor__CLASS_BASE_DOC_PY CGeomFunctor,Functor,"Functor for creating/updating :obj:`Contact.geom` objects.", /*py*/ ; woo::converters_cxxVector_pyList_2way<shared_ptr<CGeomFunctor>>(mod);
...
>{
	#define woo_dem_CPhysFunctor__CLASS_BASE_DOC_PY CPhysFunctor,Functor,"Functor for creating/updating :obj:`Contact.phys` objects.", /*py*/ ; woo::converters_cxxVector_pyList_2way<shared_ptr<CPhysFunctor>>(mod);
...
>{
	#define woo_dem_LawFunctor__CLASS_BASE_DOC_PY LawFunctor,Functor,"Functor for applying constitutive laws on :obj:`contact <Contact>`.", /*py*/ ; woo::converters_cxxVector_pyList_2way<shared_ptr<LawFunctor>>(mod);

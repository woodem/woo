...
struct Particle: public Object{
	...
	#define woo_dem_Particle__CLASS_BASE_DOC_ATTRS_PY \
		...
		.def_static("make",&Particle::make,py::arg("shape"),py::arg("mat"),py::arg("fixed")=false,"Return Particle instance created from given shape and material; nodes with DemData are automatically added to the shape, mass and inertia is recomuted.") \
		; \

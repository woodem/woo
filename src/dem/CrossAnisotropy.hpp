...
struct Cp2_FrictMat_FrictPhys_CrossAnisotropic: CPhysFunctor {
	...
	WOO_DECL_LOGGER;
	#define woo_dem_Cp2_FrictMat_FrictPhys_CrossAnisotropic__CLASS_BASE_DOC_ATTRS \
	...
	WOO_DECL__CLASS_BASE_DOC_ATTRS(woo_dem_Cp2_FrictMat_FrictPhys_CrossAnisotropic__CLASS_BASE_DOC_ATTRS);
};
...
class GlExtra_LocalAxes: public GlExtraDrawer{
	...
	WO0_CLASS_BASE_DOC_ATTRS(GlExtra_LocalAxes,GlExtraDrawer,"Render local coordinate system axes.",

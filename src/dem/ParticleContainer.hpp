...
struct ParticleContainer: public Object{
	...
	public:
		...
		#define woo_dem_ParticleContainer__CLASS_BASE_DOC_ATTRS_PY\
			...
			.def("add",&ParticleContainer::pyAppendList,py::arg("pars"),py::arg("nodes")=-1,"Add list of particles, and optionally also adding its nodes to :obj:`DemField.nodes <woo.core.Field.nodes>`; see :obj:`add` for explanation of *nodes*.") \

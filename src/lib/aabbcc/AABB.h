...
namespace aabb
{
    ...
    constexpr int Dim=VecT::RowsAtCompileTime;
	 static_assert(Dim==3);
    constexpr int dimension=Dim;
    typedef VecT::Scalar Scalar;
    typedef Eigen::Matrix<bool,VecT::ColsAtCompileTime,1> VecBoolT;
    ...
    public:
        ...
        /*! \param dimension_
            ...
            \param touchIsOverlap
                Does touching count as overlapping in query operations?
         */
        Tree(Scalar, const VecBoolT&, const VecT&,
            unsigned int nParticles = 16, bool touchIsOverlap=true);
        ...
        /*! \param periodicity_
                Whether the system is periodic in each dimension.
         */
        void setPeriodicity(const VecBoolT&);

        //! Set the size of the simulation box.
        /*! \param boxSize_
                The size of the simulation box in each dimension.
         */
        void setBoxSize(const VecT&);
         ...
         */
        bool updateParticle(unsigned int, const VecT&, const VecT&, bool alwaysReinsert=false);

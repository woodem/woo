			...
			public FunctorWrapper<_ReturnType, _ArgumentTypes>
{
	public:
		...
		#define FUNCTOR1D(type1) public: std::string get1DFunctorType1(void) WOO_CXX11_OVERRIDE {return string(#type1);} shared_ptr<DispatchType1> get1DFunctorArg1() WOO_CXX11_OVERRIDE { return make_shared<type1>();} int checkArgTypes(const shared_ptr<DispatchType1>& arg1) { return (bool)dynamic_pointer_cast<type1>(arg1)?1:0; }
		...
		virtual vector<string> getFunctorTypes(void) WOO_CXX11_OVERRIDE {vector<string> ret; ret.push_back(get1DFunctorType1()); return ret;};
			...
			public FunctorWrapper<_ReturnType, _ArgumentTypes>
{
	public:
		...
		#define FUNCTOR2D(type1,type2) public: std::string get2DFunctorType1(void) WOO_CXX11_OVERRIDE {return string(#type1);}; std::string get2DFunctorType2(void) WOO_CXX11_OVERRIDE {return string(#type2);}; shared_ptr<DispatchType1> get2DFunctorArg1() WOO_CXX11_OVERRIDE { return make_shared<type1>();} shared_ptr<DispatchType2> get2DFunctorArg2() WOO_CXX11_OVERRIDE { return make_shared<type2>();} int checkArgTypes(const shared_ptr<DispatchType1>& arg1, const shared_ptr<DispatchType2>& arg2){ if(dynamic_pointer_cast<type1>(arg1)&&dynamic_pointer_cast<type2>(arg2)) return 1; if(dynamic_pointer_cast<type1>(arg2)&&dynamic_pointer_cast<type2>(arg1)) return -1; return 0; }
		...
		virtual vector<string> getFunctorTypes() WOO_CXX11_OVERRIDE {vector<string> ret; ret.push_back(get2DFunctorType1()); ret.push_back(get2DFunctorType2()); return ret;};

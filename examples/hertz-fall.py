...
m=HertzMat(density=1e3,young=1e7,ktDivKn=.2,tanPhi=.5,surfEnergy=0.,)
...
S.dtSafety=0.06
S.engines=utils.defaultEngines(damping=.0,cp2=Cp2_HertzMat_HertzPhys(en=1.,label='cp2'),law=Law2_L6Geom_HertzPhys_DMT(noAttraction=True),dynDtPeriod=10)+[
